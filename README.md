...
### 🛠️ Tech Stack & Skills
- **Frontend:** `Next.js` | `React.js` | `Tailwind CSS` | `HTML5 Canvas`
- **Backend & DB:** `Flask` | `Django` | `Supabase` | `PostgreSQL` | `SQLAlchemy`
- **Languages:** `JavaScript (ES6)` | `Python` | `C++`
- **Audio & Engine Design:** `Web Audio API` | Hooke's Law Spring-Damper Physics Engines
